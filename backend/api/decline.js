...
export default async function handler(req, res) {
  ...
  try {
    ...
    await sendEmail(
      ...
      "Your healthcare appointment has been declined.",
      `<h2>Appointment Declined</h2>
       <p>Dear ${appointment.name},</p>
       <p>We regret to inform you that your appointment on ${appointment.date} at ${appointment.time} has been declined.</p>`
    );
