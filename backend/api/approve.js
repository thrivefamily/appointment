...
export default async function handler(req, res) {
  ...
  try {
    ...
    // 🔹 Send email (Zoho Mail)
    const transporter = nodemailer.createTransport({
      host: "smtp.zoho.com", // For personal Zoho accounts
      port: 465,             // SSL port
      secure: true,
      auth: {
    ...
    await transporter.sendMail({
      ...
      html: `
       ...
       <p>
  <a href="mailto:careme2005@yahoo.com">careme2005@yahoo.com</a> | 
  <a href="mailto:yk4me2002@yahoo.com">yk4me2002@yahoo.com</a>
</p>
</p>
          <br/>
